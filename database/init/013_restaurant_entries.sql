...
SELECT 'Maddies', 'American', 'Sandwiches, salads, and all-day comfort food.', 42, 4.70, 'M', '#f6c177', TRUE
...
INSERT INTO restaurants (name, cuisine, description, times_ordered, average_rating, icon, color, active)
SELECT 'Pressed Cafe', 'Mediterranean', 'Bright, quick Mediterranean plates and pita.', 29, 4.80, 'P', '#c4a7e7', TRUE
